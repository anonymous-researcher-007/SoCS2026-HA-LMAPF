...
----
  ...
  den520d          data/maps/den520d.map                    (den520d game map)  [LARGE]
...
#   Large maps (warehouse_large, den520d): first 4 only (lacam, lacam3, pibt2, lns2)
